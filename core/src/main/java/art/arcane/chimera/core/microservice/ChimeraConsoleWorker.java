...
/**
 * The chimera console worker is used to manage console commands. You can register commands for your service here.
 */
@EqualsAndHashCode(callSuper = true)
@Data
public class ChimeraConsoleWorker extends ChimeraServiceWorker {
