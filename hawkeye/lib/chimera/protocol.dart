...
class ChimeraParagon {
  ...
  static Future<List<String>> getGradleProjects() async {
    try {
      return WrappedObject.of(await ChimeraSocketHelper.invoke(
              "getGradleProjects", <dynamic>[]))
          .get(listType: '!String') as List<String>;
    } catch (e) {
      print('Failed to convert result -> List<String>: (probably null) $e');
      return null;
    }
  }

  /// Invokes getFlutterProjects(...) on the Remote Paragon Service on the Chimera Network
  static Future<List<String>> getFlutterProjects() async {
    try {
      return WrappedObject.of(await ChimeraSocketHelper.invoke(
              "getFlutterProjects", <dynamic>[]))
          .get(listType: '!String') as List<String>;
    } catch (e) {
      print('Failed to convert result -> List<String>: (probably null) $e');
      return null;
  ...
  static Future<bool> gradleClean(String project) async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "gradleClean", <dynamic>[project])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  }

  /// Invokes gradleArtifact(...) on the Remote Paragon Service on the Chimera Network
  static Future<bool> gradleArtifact(String project) async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "gradleArtifact", <dynamic>[project])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> gitSync() async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob("gitSync", <dynamic>[]))
          as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
  ...
  static Future<bool> flutterBuildAPK(String project) async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "flutterBuildAPK", <dynamic>[project])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> flutterBuildWeb(String project) async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "flutterBuildWeb", <dynamic>[project])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> flutterClean(String project) async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "flutterClean", <dynamic>[project])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> flutterPrecache() async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "flutterPrecache", <dynamic>[])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> flutterUpgrade() async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "flutterUpgrade", <dynamic>[])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> gradleBuild(String project) async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "gradleBuild", <dynamic>[project])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> gitPull() async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob("gitPull", <dynamic>[]))
          as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
  ...
  static Future<bool> flutterBuildAAB(String project) async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob(
          "flutterBuildAAB", <dynamic>[project])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> gitDiscard() async {
    try {
      return await (ChimeraSocketHelper.invokeBigJob("gitDiscard", <dynamic>[]))
          as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
...
class ChimeraAccount {
  ...
  static Future<bool> releaseToken() async {
    try {
      return await (ChimeraSocketHelper.invoke("releaseToken", <dynamic>[]))
          as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
  ...
  static Future<User> signUp(
    ...
    try {
      return WrappedObject.of(await ChimeraSocketHelper.invoke(
              "signUp", <dynamic>[firstName, lastName, email, password]))
          .get() as User;
    } catch (e) {
      print('Failed to convert result -> User: (probably null) $e');
      return null;
    }
  }

  /// Invokes getSomeStream(...) on the Remote Account Service on the Chimera Network
  static Future<InputStream> getSomeStream() async {
    try {
      return WrappedObject.of(
              await ChimeraSocketHelper.invoke("getSomeStream", <dynamic>[]))
          .get() as InputStream;
    } catch (e) {
      print('Failed to convert result -> InputStream: (probably null) $e');
      return null;
    }
  }

  /// Invokes aquireToken(...) on the Remote Account Service on the Chimera Network
  static Future<AccessToken> aquireToken(String email, String password) async {
    try {
      return WrappedObject.of(await ChimeraSocketHelper.invoke(
              "aquireToken", <dynamic>[email, password]))
          .get() as AccessToken;
    } catch (e) {
      print('Failed to convert result -> AccessToken: (probably null) $e');
      return null;
    }
  }
  ...
  static Future<User> getMe() async {
    try {
      return WrappedObject.of(
              await ChimeraSocketHelper.invoke("getMe", <dynamic>[]))
          .get() as User;
    } catch (e) {
      print('Failed to convert result -> User: (probably null) $e');
      return null;
  ...
  static Future<bool> validateToken(AccessToken token) async {
    try {
      return await (ChimeraSocketHelper.invoke(
          "validateToken", <dynamic>[token.toJson()])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> requestChangePassword(
      String currentPassword, String newPassword) async {
    try {
      return await (ChimeraSocketHelper.invoke(
              "requestChangePassword", <dynamic>[currentPassword, newPassword]))
          as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
...
class ChimeraGateway {
  ...
  static Future<bool> isRegistered(ID id) async {
    try {
      return await (ChimeraSocketHelper.invoke(
          "isRegistered", <dynamic>[id.toJson()])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<String> getSessionId() async {
    try {
      return await (ChimeraSocketHelper.invoke("getSessionId", <dynamic>[]))
          as String;
    } catch (e) {
      print('Failed to convert result -> String: (probably null) $e');
      return null;
    }
  }
  ...
  static Future<bool> ping() async {
    try {
      return await (ChimeraSocketHelper.invoke("ping", <dynamic>[])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<bool> unregisterListener(ID id) async {
    try {
      return await (ChimeraSocketHelper.invoke(
          "unregisterListener", <dynamic>[id.toJson()])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  static Future<ID> registerListener(ID target) async {
    try {
      return WrappedObject.of(await ChimeraSocketHelper.invoke(
              "registerListener", <dynamic>[target.toJson()]))
          .get() as ID;
    } catch (e) {
      print('Failed to convert result -> ID: (probably null) $e');
      return null;
    }
  }

  /// Invokes unregisterAll(...) on the Remote Gateway Service on the Chimera Network
  static Future<int> unregisterAll() async {
    try {
      return await (ChimeraSocketHelper.invoke("unregisterAll", <dynamic>[]))
          as int;
    } catch (e) {
      print('Failed to convert result -> int: (probably null) $e');
      return null;
    }
  }

  /// Invokes unregisterAllWithTarget(...) on the Remote Gateway Service on the Chimera Network
  static Future<int> unregisterAllWithTarget(ID target) async {
    try {
      return await (ChimeraSocketHelper.invoke(
          "unregisterAllWithTarget", <dynamic>[target.toJson()])) as int;
    } catch (e) {
      print('Failed to convert result -> int: (probably null) $e');
      return null;
    }
...
/// Represents the Remote Guide Service on the Chimera Network
class ChimeraGuide {
  /// Invokes moveShelf(...) on the Remote Guide Service on the Chimera Network
  static Future<bool> moveShelf(ID shelf, ID newParent) async {
    try {
      return await (ChimeraSocketHelper.invoke(
          "moveShelf", <dynamic>[shelf.toJson(), newParent.toJson()])) as bool;
    } catch (e) {
      print('Failed to convert result -> bool: (probably null) $e');
      return null;
    }
  ...
  /// Invokes countShelvesInParent(...) on the Remote Guide Service on the Chimera Network
  static Future<int> countShelvesInParent(ID parent) async {
    try {
      return await (ChimeraSocketHelper.invoke(
          "countShelvesInParent", <dynamic>[parent.toJson()])) as int;
    } catch (e) {
      print('Failed to convert result -> int: (probably null) $e');
      return null;
    }
...
class GuideData {
  ...
  static GuideData fromJson(Map<String, dynamic> json) {
    return GuideData()
      ..root = GuideComponent.fromJson(
          (json['root'] ?? Map<String, dynamic>()) as Map<String, dynamic>);
  }
...
class Listener {
  ...
  static Listener fromJson(Map<String, dynamic> json) {
    return Listener()
      ..id = ID.fromJson(
          (json['id'] ?? Map<String, dynamic>()) as Map<String, dynamic>)
      ..target = ID.fromJson(
          (json['target'] ?? Map<String, dynamic>()) as Map<String, dynamic>)
...
class Shelf {
  ...
  static Shelf fromJson(Map<String, dynamic> json) {
    return Shelf()
      ...
      ..color = json['color']
      ..parent = ID.fromJson(
          (json['parent'] ?? Map<String, dynamic>()) as Map<String, dynamic>);
  }
  ...
  static AccessToken fromJson(Map<String, dynamic> json) {
    return AccessToken()
      ..id = ID.fromJson(
          (json['id'] ?? Map<String, dynamic>()) as Map<String, dynamic>)
      ..account = ID.fromJson(
          (json['account'] ?? Map<String, dynamic>()) as Map<String, dynamic>)
      ..type = json['type']
...
class Session {
  ...
  static Session fromJson(Map<String, dynamic> json) {
    return Session()
      ...
      ..token = ID.fromJson(
          (json['token'] ?? Map<String, dynamic>()) as Map<String, dynamic>)
      ..user = ID.fromJson(
          (json['user'] ?? Map<String, dynamic>()) as Map<String, dynamic>)
      ..last = json['last'];
  }
...
class INTERNALChimeraObjectDiscovery {
  ...
  static String getTypeName(dynamic t) {
    if (t is GuideData) {
      return 'GuideData';
    }
    if (t is Listener) {
    ...
    if (t is UserAuthentication) {
      return 'UserAuthentication';
    }
    if (t is GuideComponent) {
      return 'GuideComponent';
    }
    if (t is AccessToken) {
      return 'AccessToken';
    ...
    print('ERROR: UNKNOWN DYNAMIC TYPE: ${t.runtimeType.toString()}');
    return 'ERRORUnknownType';
  }

  /// Unwraps the string into a real object.
  static dynamic fromIdentifiedString(String t) =>
      WrappedObject.of(jsonDecode(t)).get();

  /// Checks if the given object is suppored for json & networking with chimera.
  static bool isSupported(dynamic t) =>
      t is GuideData ||
      t is Listener ||
      t is User ||
      t is UserPersonal ||
  ...
  static bool isSupportedType(dynamic t) =>
      t == GuideData ||
      t == Listener ||
      t == User ||
      t == UserPersonal ||
  ...
  static String toIdentifiedString(dynamic t) {
    if (t is GuideData) {
      return jsonEncode(
          WrappedObject.create('GuideData', t.toJson()).toWrappedJson());
    }
    if (t is Listener) {
      return jsonEncode(
          WrappedObject.create('Listener', t.toJson()).toWrappedJson());
    }
    if (t is User) {
      return jsonEncode(
          WrappedObject.create('User', t.toJson()).toWrappedJson());
    }
    if (t is UserPersonal) {
      return jsonEncode(
          WrappedObject.create('UserPersonal', t.toJson()).toWrappedJson());
    }
    if (t is InputStream) {
      return jsonEncode(
          WrappedObject.create('InputStream', t.toJson()).toWrappedJson());
    }
    if (t is Shelf) {
      return jsonEncode(
          WrappedObject.create('Shelf', t.toJson()).toWrappedJson());
    }
    if (t is ServiceJob) {
      return jsonEncode(
          WrappedObject.create('ServiceJob', t.toJson()).toWrappedJson());
    }
    if (t is UserAuthentication) {
      return jsonEncode(WrappedObject.create('UserAuthentication', t.toJson())
          .toWrappedJson());
    }
    if (t is GuideComponent) {
      return jsonEncode(
          WrappedObject.create('GuideComponent', t.toJson()).toWrappedJson());
    }
    if (t is AccessToken) {
      return jsonEncode(
          WrappedObject.create('AccessToken', t.toJson()).toWrappedJson());
    }
    if (t is ID) {
      return jsonEncode(WrappedObject.create('ID', t.toJson()).toWrappedJson());
    }
    if (t is Session) {
      return jsonEncode(
          WrappedObject.create('Session', t.toJson()).toWrappedJson());
    }
    print('ERROR: UNKNOWN DYNAMIC TYPE: ${t.runtimeType.toString()}');
    return null;
  }
