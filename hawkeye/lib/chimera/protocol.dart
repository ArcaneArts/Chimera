...
static Future<bool> moveShelf(ID shelf,ID newParent) async { try{ 
return await (ChimeraSocketHelper.invoke("moveShelf",<dynamic>[shelf.toJson(),newParent.toJson()]))as bool;}catch(e){ print('Failed to convert result -> bool: (probably null) $e'); return null; }}
null
/// Invokes countShelvesInParent(...) on the Remote Guide Service on the Chimera Network
static Future<int> countShelvesInParent(ID parent) async { try{ 
return await (ChimeraSocketHelper.invoke("countShelvesInParent",<dynamic>[parent.toJson()]))as int;}catch(e){ print('Failed to convert result -> int: (probably null) $e'); return null; }}
null
null
null
}
